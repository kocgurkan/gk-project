...
} # bu sg bos yaptigi su = asagidak worker ve master'lari birbirlerine port yada sg baglamak istiyoruz.
# ama ayni anda olustuklari icin bu mumkun degil.
# bu yuzden ici bos farkli bir sn olusturup ona baglayinca istedigimiz gibi calisicak.
# 10250 portu icin = self, control plane icin gecerli; documentation'da var.
...
resource "aws_instance" "kube-master" {
    ...
    key_name = "mattkey"
    subnet_id = "subnet-07d2a6f3e37637ed1"  # select own subnet_id of us-east-1a
